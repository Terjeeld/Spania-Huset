...
DATAFIL = os.path.join(os.path.dirname(__file__), "data", "bookings.csv")
os.makedirs(os.path.dirname(DATAFIL), exist_ok=True)
st.write("📂 Absolutt sti til bookings.csv:", os.path.abspath(DATAFIL))
st.write("📁 Nåværende arbeidsmappe:", os.getcwd())
...
if os.path.exists(DATAFIL):
    ...
    st.warning("📄 bookings.csv ble ikke funnet og ble opprettet automatisk.")
